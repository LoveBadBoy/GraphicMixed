...
// kLMChineseT         @"zh-Hant"
    ...
    self.itemTintColor = [UIColor grayColor];
...
#warning 关键啊关键
            NSLog(@"-=-=-=-=-=-=-=-=-=-=-=-%@", [[NSURL fileURLWithPath:path] absoluteString]);
...
//            [self.editorView replaceLocalImageWithRemoteImage:@"http://cms-bucket.nosdn.127.net/7be241aaded74e5fa4653f90245e7bac20160807145921.jpeg" uniqueId:imageID];
        });
    }];
